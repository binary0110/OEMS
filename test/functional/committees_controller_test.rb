...
class CommitteesControllerTest < ActionController::TestCase
  ...
  test "should create committee" do
    assert_difference('Committee.count') do
      post :create, committee: { firstname: @committee.firstname, position: @committee.position, surname: @committee.surname, title: @committee.title }
    end
  ...
  test "should update committee" do
    put :update, id: @committee, committee: { firstname: @committee.firstname, position: @committee.position, surname: @committee.surname, title: @committee.title }
    assert_redirected_to committee_path(assigns(:committee))
  end
